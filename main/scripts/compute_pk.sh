...
srun -N 2 -n 16 -C cpu -t 04:00:00 --qos interactive --account desi python ${PK_RUN} --tracer ${TRACER} --region ${REGION} --weight_type default_FKP --rebinning y --nran ${RAN_MOCK_NUM} --basedir ${MOCKS_FN} --outdir ${PK_FN} --thetacut 0.05  --calc_win y